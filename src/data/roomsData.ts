...
export const ROOMS_BY_LOCATION: Record<string, RoomData[]> = {
  ...
  tindivanam: [
    ...
    },
    {
      ...
      type: "Twin",
      description:
        "Well-appointed twin bedding room providing cozy relaxation, extra legroom, and modern amenities along the Tindivanam route.",
      pricePerNight: 3500,
      currency: "INR",
      images: [
        "/images/Twin bed.jpeg",
    ...
    },
    {
      ...
      type: "Suite",
      description:
        "Generously sized executive suite equipped with large bed, comfortable lounge seating, mini fridge, and complete family amenities.",
      pricePerNight: 5500,
      currency: "INR",
      images: [
        "/images/Delux room.jpeg",
