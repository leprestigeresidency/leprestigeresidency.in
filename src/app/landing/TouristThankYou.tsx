      ...
      <div>
        ...
        <section className="py-12 md:py-20 bg-gradient-to-b from-[#F3EEE7] to-[#F8F4EE]">
          <div className="max-w-[700px] mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <p className="font-sans text-base sm:text-lg text-[#575757] leading-relaxed max-w-xl mx-auto">
              Your enquiry is received. Our team will reach you within the hour.
            </p>

            <div className="bg-[#262626] p-6 rounded-2xl text-left border border-[#404040] shadow-xl text-white space-y-4 my-8">
              ...
              <div className="bg-white/5 p-4 rounded-xl space-y-3">
                <h4 className="font-serif text-lg font-bold text-[#D8B98A]">How to book now:</h4>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-transparent border-2 border-white hover:bg-white hover:text-[#262626] text-white font-sans font-bold text-sm uppercase tracking-wider rounded-xl transition-all"
                >
            ...
            <p className="text-sm font-bold text-[#C45A37] uppercase tracking-wider">
              14 rooms booked this week. Weekend dates fill fast.
            </p>

            <div className="pt-8">
              <p className="text-xs text-[#575757] font-medium max-w-xl mx-auto leading-relaxed bg-white border border-[#E5DED5] p-3 rounded-lg shadow-sm">
                <strong>Just minutes away:</strong> Promenade Beach (13 mins) · Botanical Garden (10 mins) · Sri Aurobindo Ashram (15 mins) · bus stop & auto stand (2 mins, right outside).
              </p>
            </div>
