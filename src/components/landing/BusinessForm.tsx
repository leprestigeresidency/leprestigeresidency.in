// ── Le Prestige — Business Landing Page Booking Form ────────────────
    ...
    <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-10 shadow-xl border border-[#E5DED5]">
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.name ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.phone ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label className="block text-xs font-sans font-semibold uppercase tracking-wider text-[#262626] mb-2">
              Check-in Date <span className="text-[#0284C7]">*</span>
            </label>
            <input
              type="date"
              name="checkIn"
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.checkIn ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            />
          ...
          <div>
            <label className="block text-xs font-sans font-semibold uppercase tracking-wider text-[#262626] mb-2">
              Check-out Date <span className="text-[#0284C7]">*</span>
            </label>
            <input
              type="date"
              name="checkOut"
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.checkOut ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label className="block text-xs font-sans font-semibold uppercase tracking-wider text-[#262626] mb-2">
              Number of Guests <span className="text-[#0284C7]">*</span>
            </label>
            <select
              name="guests"
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.guests ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            >
              <option value="1 Guest">1 Guest</option>
              <option value="2 Guests">2 Guests</option>
              <option value="3 Guests">3 Guests</option>
              <option value="4+ Guests">4+ Guests / Team</option>
            </select>
          ...
          <div>
            <label className="block text-xs font-sans font-semibold uppercase tracking-wider text-[#262626] mb-2">
              Room Preference <span className="text-[#0284C7]">*</span>
            </label>
            <select
              name="roomPreference"
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 text-sm font-sans rounded-xl bg-white border text-[#262626] focus:outline-none transition-all ${
                errors.roomPreference ? "border-red-500" : "border-[#E2E8F0] focus:border-[#0284C7]"
              }`}
            >
        ...
        <div className="flex items-center gap-2 pt-2">
          ...
          />
          <label htmlFor="captcha" className="text-sm text-[#262626] font-semibold">I'm not a robot <span className="text-[#0284C7]">*</span></label>
        </div>
        ...
        <button
          ...
          className="w-full py-4 px-6 text-sm font-sans font-bold uppercase tracking-wider text-white bg-[#262626] hover:bg-[#1C1C1C] rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-baseline justify-center gap-2 cursor-pointer disabled:opacity-80"
        >
          {isSubmitting ? (
            <>
