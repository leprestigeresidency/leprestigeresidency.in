...
async function runTest() {
  ...
  console.log('\n=======================================');
  console.log('         LOAD TEST RUN RESULTS         ');
  console.log('=======================================');
  console.log(`Total Simulated Users    : ${TOTAL_USERS}`);
  console.log(`Successful Requests      : ${successful}`);
  console.log(`Failed Requests          : ${failed}`);
  console.log(`Total Time Taken         : ${totalTime.toFixed(2)} seconds`);
  console.log(`Throughput               : ${(TOTAL_USERS / totalTime).toFixed(2)} req/sec`);
  console.log(`Average Response Time    : ${avgLatency.toFixed(2)} ms`);
  console.log(`95th Percentile Latency  : ${p95.toFixed(2)} ms`);
  console.log(`99th Percentile Latency  : ${p99.toFixed(2)} ms`);
  console.log('=======================================\n');
}
